...
{
    public class AutBaseAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public AutBaseAttribute(string attr)
        {
            this._indice = attr;
        ...
        public Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                UtilisateurAPI utilisateur = new UtilisateurAPIService().Donner(login, motDePasse);
                                
                if (utilisateur==null) throw new UnauthorizedAccessException();
                if (!(this._indice == "-")) throw new UnauthorizedAccessException();
