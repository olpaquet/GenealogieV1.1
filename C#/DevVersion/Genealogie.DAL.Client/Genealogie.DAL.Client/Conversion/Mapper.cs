...
namespace Genealogie.DAL.Client.Conversion
{
    public static class Mapper
    {
        ...
        public static Descendant VersClient(this gl.Descendant e) { if (e == null) return null; return new Descendant { id = e.id, parent = e.parent.VersClient(), enfant = e.enfant.VersClient() }; }
        public static gl.Descendant VersGlobal(this Descendant e) { if (e == null) return null; return new gl.Descendant { id = e.id, parent = e.parent.VersGlobal(), enfant = e.enfant.VersGlobal() }; }
